...
All well known query responses are the same and will be 989 or 991 bytes.

### Example Request / Response

- RFC Version Request: `44010f3cd19796c1c13cff0000`
  - `D<ї���<�`
- Response: 458 bytes (not incl headers)
